...
public class DetailEditCustomerUploaded extends FragmentActivity {
    private Context act;
    ...
    private static final String LOG_TAG = DetailEditCustomerUploaded.class
            .getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_customer_edit_uploaded);
        act = this;
        ...
        etAlamatCustomer = (TextView) findViewById(R.id.activity_customer_prospect_alamat_customer_value);
        ...
        etTelpCustomer = (TextView) findViewById(R.id.activity_customer_prospect_telp_customer_value);
        etno_ktp = (TextView) findViewById(R.id.activity_customer_prospect_no_ktp_value);
        etTanggal_lahir = (TextView) findViewById(R.id.activity_customer_prospect_tanggal_lahir_value);
        etNama_bank = (TextView) findViewById(R.id.activity_customer_prospect_nama_bank_value);
        etNo_rekenig = (TextView) findViewById(R.id.activity_customer_prospect_no_rekening_value);
        etAtas_nama = (TextView) findViewById(R.id.activity_customer_prospect_atas_nama_value);
        etNpwp = (TextView) findViewById(R.id.activity_customer_prospect_npwp_value);

        etNama_pasar = (TextView) findViewById(R.id.activity_customer_prospect_nama_pasar_value);
        spinnerCluster = (Spinner) findViewById(R.id.activity_customer_prospect_cluster_value);
        //etCluster = (TextView) findViewById(R.id.activity_customer_prospect_cluster_value);
        etTelp = (TextView) findViewById(R.id.activity_customer_prospect_telp_value);
        etFax = (TextView) findViewById(R.id.activity_customer_prospect_fax_value);
        etOmset = (TextView) findViewById(R.id.activity_customer_prospect_omset_value);
        etCara_pembayaran = (TextView) findViewById(R.id.activity_customer_prospect_cara_pembayaran_value);
        etPlafon_kredit = (TextView) findViewById(R.id.activity_customer_prospect_plafon_value);
        etTerm_kredit = (TextView) findViewById(R.id.activity_customer_prospect_term_value);

        etNama_istri = (TextView) findViewById(R.id.activity_customer_prospect_nama_istri_value);
        etNama_anak1 = (TextView) findViewById(R.id.activity_customer_prospect_nama_anak1_value);
        etNama_anak2 = (TextView) findViewById(R.id.activity_customer_prospect_nama_anak2_value);
        etNama_anak3 = (TextView) findViewById(R.id.activity_customer_prospect_nama_anak3_value);
        etKode_pos = (TextView) findViewById(R.id.activity_customer_prospect_kode_pos_value);
        tgStatus = (ToggleButton) findViewById(R.id.activity_customer_detail_status_value);
        etDescription = (TextView) findViewById(R.id.activity_customer_prospect_description_value);
        ...
        mButtonCustomerDetailPreview.setVisibility(View.INVISIBLE);
        mButtonCustomerDetailMap.setVisibility(View.INVISIBLE);
        mButtonCustomerDetailSave.setVisibility(View.INVISIBLE);
    ...
    public void gotoCustomerLocator() {
        ...
        if (main_app_table_id != null) {
            ...
            Intent intentActivity = new Intent(
                    DetailEditCustomerUploaded.this,
    ...
    */
    ...
    private void previewImageDialog() {
        if (customer != null) {
            ...
            imagesDialog.setContentView(DetailEditCustomerUploaded.this
    ...
    public void gotoCustomer() {
        Intent i = new Intent(this, CheckCustomer.class);
        startActivity(i);
        finish();
    }
}
