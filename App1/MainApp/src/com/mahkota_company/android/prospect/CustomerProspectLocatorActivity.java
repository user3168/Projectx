...
public class CustomerProspectLocatorActivity extends Activity implements
		LocationListener {
	private Context act;
	...
	private static final String LOG_TAG = CustomerProspectLocatorActivity.class
			.getSimpleName();

	@Override
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_detail_customer_prospect_locator);
		act = this;
	...
	public void gotoDetailCustomerProspect() {
		...
		if (main_app_table_id != null) {
			saveAppDataCustomerIdCustomer(main_app_table_id);
			Intent i = new Intent(CustomerProspectLocatorActivity.this,
					DetailCustomerProspectActivity.class);
			startActivity(i);
			finish();
		} else {
			gotoCustomerProspect();
