...
public class PerbaikanEditActivity extends FragmentActivity {
    private Context act;
    ...
    private static final String LOG_TAG = com.mahkota_company.android.Perbaikan.PerbaikanEditActivity.class
            .getSimpleName();
    ...
    */
    ...
    private void previewImageDialog() {
        if (customer != null) {
            ...
            imagesDialog.setContentView(com.mahkota_company.android.Perbaikan.PerbaikanEditActivity.this
