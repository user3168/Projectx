...
public class DetailCheckCustomerProspectActivity extends FragmentActivity {
	...
	private static final String LOG_TAG = DetailCheckCustomerProspectActivity.class
			.getSimpleName();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_detail_customer_prospect_uploaded);
		act = this;
	...
	public void gotoCustomerLocator() {
		...
		if (main_app_table_id != null) {
			...
			Intent intentActivity = new Intent(
					DetailCheckCustomerProspectActivity.this,
	...
	private void previewImageDialog() {
		if (customer != null) {
			...
			imagesDialog.setContentView(DetailCheckCustomerProspectActivity.this
	...
	public void gotoCustomerProspect() {
		Intent i = new Intent(this, CheckCustomerProspectActivity.class);
		startActivity(i);
		finish();
	}
}
